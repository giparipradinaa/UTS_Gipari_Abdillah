            ...
            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form id="loginForm" method="post" action="simpan_pendaftaran.php" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>PRODI</label>
                                    <input type="number" class="form-control" name="prodi" required>
                                </div>
                                <div class="form-group col-lg-6">
                            ...
                            <div class="text-center">
                                ...
                                <button href="login.php" class="btn btn-default">Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
